...
# Тестовый запуск — можно закомментировать после успешного импорта
if __name__ == "__main__":
    # create_table()         # ← создаёт таблицу, если её нет
    # import_from_excel()    # ← загружает данные из Excel в БД
    pass  # ← заглушка, чтобы блок не был пустым
